...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KemonoFantia = exports.KemonoFantiaInfo = void 0;
const types_1 = require("@paperback/types");
const KEMONO_BASE_URL = 'https://kemono.cr';
const KEMONO_API_URL = 'https://kemono.cr/api/v1';
const SERVICE = 'fantia';
const SERVICE_NAME = 'Fantia';
exports.KemonoFantiaInfo = {
    version: '1.0.0',
...
class KemonoInterceptor {
    ...
    async interceptRequest(request) { return request; }
}
class KemonoFantia extends types_1.Source {
    constructor() {
        super(...arguments);
...
exports.KemonoFantia = KemonoFantia;
